        ...
        for action in self.Q[state]:
            if maxQ is None:
                ...
                if q > maxQ:
                    ...
                    maxQ_action_list.append(action)
        
        maxQ_action = random.choice(maxQ_action_list)
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, alpha=0.2, epsilon=1.0)
